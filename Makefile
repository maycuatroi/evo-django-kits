...
test: lint        ## Run tests and generate coverage report.
	$(ENV_PREFIX)pytest -v --cov-config .coveragerc --cov=evo_django_kits -l --tb=short --maxfail=1 tests/
...
release:          ## Create a new tag for release.
	...
	@echo "$${TAG}" > evo_django_kits/VERSION
	@$(ENV_PREFIX)gitchangelog > HISTORY.md
	@git add evo_django_kits/VERSION HISTORY.md
...
switch-to-poetry: ## Switch to poetry package manager.
	...
	@echo "evo_django_kits = 'evo_django_kits.__main__:main'" >> pyproject.toml
	...
	@echo "Please run 'poetry shell' or 'poetry run evo_django_kits'"
